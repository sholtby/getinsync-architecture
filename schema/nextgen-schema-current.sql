...
COMMENT ON TABLE public.application_categories IS 'Namespace-scoped application classification taxonomy. ARM v2.0. Apps may have many categories (M:M via application_category_assignments).';
