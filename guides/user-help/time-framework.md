...
See [Creating and Managing Initiatives](/roadmap-initiatives) to turn your TIME analysis into funded action plans.

---

## Common Misconceptions

- **TIME is not a risk framework.** It answers "what to do" (strategic direction), not "how urgent." For urgency, see the [PAID framework](/paid-framework).
