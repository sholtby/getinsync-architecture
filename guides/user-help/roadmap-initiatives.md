...
- [TIME Quadrant Explanation](time-framework.md) — Understand what drives the "what to do" decision
- [PAID Quadrant Explanation](paid-framework.md) — Understand what drives the "how urgent" decision
- [Reading Tech Health Indicators](tech-health.md) — Find at-risk technologies that need initiatives
