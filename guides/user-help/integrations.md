...
- [What Are Deployment Profiles?](/deployment-profiles) — Understand where applications run
- [Creating and Managing Initiatives](/roadmap-initiatives) — Plan changes that account for integrations
