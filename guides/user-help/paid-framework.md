...
- [TIME Quadrant Explanation](/time-framework) — Understand strategic direction scoring
- [How to Assess an Application](/assessment-guide) — The assessment process that feeds both frameworks
- [Creating and Managing Initiatives](/roadmap-initiatives) — Turn PAID urgency into funded projects
