...
| 5 | `ANTHROPIC_API_KEY` | Claude API access for AI-powered features | `lifecycle-lookup`, `apm-chat` Edge Functions | Stuart Holtby | 2026-03-13 | Every 90 days | Confidential |
