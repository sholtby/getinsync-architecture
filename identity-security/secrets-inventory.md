...
| 5 | `ANTHROPIC_API_KEY` | Claude API access for AI-powered features | `lifecycle-lookup` Edge Function | Stuart Holtby | 2026-02 | Every 90 days | Confidential |
| 6 | `OPENAI_API_KEY` | OpenAI Embeddings API (`text-embedding-3-small`) | `embed-entity` Edge Function (Phase 2) | Stuart Holtby (Service Account) | 2026-03-13 | Every 90 days | Confidential |
